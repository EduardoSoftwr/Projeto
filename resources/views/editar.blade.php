...
<head>
    ...
    <title>Ponto Convê Bebidas - Todos os Produtos</title>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card__counter">
                <form action="{{ route('produtos.excluir', $produto->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="button"><i class="fas fa-trash-alt svgIcon"></i></button>
                </form>
